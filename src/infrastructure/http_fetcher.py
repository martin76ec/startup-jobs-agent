...
def extract_metadata(soup):
  ...
  metadata = {"title": None, "description": None, "keywords": None, "author": None}
...
def generic_scraper(url: str):
  ...
  try:
    ...
    return {"url": url, "metadata": metadata, "main_content": main_content, "structured_data": structured_data, "status": "success"}
